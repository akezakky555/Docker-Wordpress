...
View [DEMO](https://www.wponlinesupport.com/wp-plugin/featured-post-creative/) for more informations.

Check [PRO DEMO and Features](https://www.wponlinesupport.com/wp-plugin/featured-post-creative/) for more details.
...
= Shortcodes =
* <code>[featured_post limit="10"]</code>
* <code>[fpc_post_grid]</code>

= Templete code =

* <code><?php echo do_shortcode('[featured_post limit="10"]'); ?></code>
...
* **Limit :** [featured_post limit="10"] (Display latest 10 featured post).
* **Show_author :** [featured_post show_author="true"] (Display featured post author OR not. By default value is “true”. Values are “true” OR “false” )
* **Category :** [featured_post category="category_id"] (Display featured post categories wise).
* **Show_category_name :** [featured_post show_category_name="true" ] (Display featured post category name OR not. By default value is “true”. Options are “true OR false”).
* **Show_date :** [featured_post show_date="false"] (Display featured post date OR not. By default value is “true”. Options are “true OR false”)
* **Order :** [featured_post order="DESC"] (Controls featured post order. Values are "ASC" OR "DESC".)
* **Orderby :** [featured_post orderby="post_date"] (Display featured post in your order. Values are "post_date", "modified", "title", "name" (Post Slug), "ID", "rand", "menu_order", "comment_count")
* **Image Height :** [featured_post image_height="500"] (Control featured post image height.)
